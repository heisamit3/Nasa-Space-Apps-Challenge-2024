  ...
  return (
    <div className="educational-resources-container">
      ...
      <nav className="navbar">
        <ul>
          <li>
            <a onClick={() => handleNavigation("gases")}>Greenhouse Gases</a>
          </li>
          <li>
            <a onClick={() => handleNavigation("causes")}>Causes of Climate Change</a>
          </li>
          <li>
            <a onClick={() => handleNavigation("fightback")}>How to Fight Climate Change</a>
          </li>
          <li>
            <a onClick={() => handleNavigation("treeplantation")}>Tree Plantation</a>
          </li>
        </ul>
      </nav>
      ...
      <section id="gases" className="content-section">
        ...
        <ul>
          <li>
            <strong>Carbon Dioxide (CO<sub>2</sub>):</strong> Mainly produced
            from burning fossil fuels like coal, oil, and gas.
          </li>
          <li>
            <strong>Methane (CH<sub>4</sub>):</strong> Emitted during the
            production and transport of coal, oil, and natural gas.
          </li>
          <li>
            <strong>Nitrous Oxide (N<sub>2</sub>O):</strong> Released from
            agricultural and industrial activities, as well as combustion of
            fossil fuels.
          </li>
        </ul>
      </section>
