...
import "../../css/MiCasaUnifiedPage.css"; // Import unified page styles
...
const MiCasaMapWithDataPage: React.FC = () => {
  ...
  return (
    <div className="map-data-container">
      <h1 className="text-2xl font-bold p-4 text-orange-500">
        Search or click on the map to view MiCasa Carbon emissions data
      </h1>
...
export default MiCasaMapWithDataPage;
